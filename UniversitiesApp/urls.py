...
urlpatterns = [
    ...
    url(r'^university/course/manageit$', views.manageCourse, name="ManageCourse"),
	url(r'^university/course/join$', views.joinCourse, name="JoinCourse"),
	url(r'^university/course/removeStudent$', views.removeStudent, name="JoinCourse"),
	url(r'^university/course/addStudent$', views.addStudent, name="JoinCourse"),
